    ...
    return(
      ...
      <nav className="flex items-center gap-8 text-gray-500 font-semibold">
        <Link className="mr-10 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300" href={'/'}><img className="w-24 h-34" src="/logo.png"></img></Link>
         ...
         <Link className="hover:text-red-700 focus:text-red-700 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300" href={'/rolunk'}><img className="w-5 h-5 float-left mt-0.5" src="/sulyzo1.png"></img>Rolunk<img className="w-5 h-5 float-right mt-0.5" src="/sulyzo2.png"></img></Link>
         <Link className="hover:text-red-700 focus:text-red-700 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300" href={'/motivacio'}><img className="w-5 h-5 float-left mt-0.5" src="/sulyzo1.png"></img>Motivacio<img className="w-5 h-5 float-right mt-0.5" src="/sulyzo2.png"></img></Link>
